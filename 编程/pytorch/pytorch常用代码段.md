...
![img](https://pic1.zhimg.com/80/v2-e49fdbb7cee05950a4108e607875bdd4_720w.jpg)
...
除了Char Tensor，其他所有CPU上的张量都支持转换为numpy格式然后再转换回来。
...
[szagoruyko/pytorchvizgithub.com](https://github.com/szagoruyko/pytorchviz)

### **类似 Keras 的 model.summary() 输出模型信息（**使用pytorch-summary **）**

[sksq96/pytorch-summarygithub.com](https://github.com/sksq96/pytorch-summary)
...
- 不要使用太大的线性层。因为nn.Linear(m,n)使用的是 ![[公式]](https://www.zhihu.com/equation?tex=O%28mn%29) 的内存，线性层太大很容易超出现有显存。
...
[https://github.com/zasdfgbnm/TorchSnoopergithub.com](https://github.com/zasdfgbnm/TorchSnooper)

- 模型可解释性，使用captum库

[https://captum.ai/captum.ai](https://captum.ai/)
